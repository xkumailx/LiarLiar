    ...
    <>
      ...
      <Section className="py-8">
        <div className="flex flex-col md:flex-row gap-[1em]">
          <div className="w-full mt-[5em] md:w-1/3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
          <div className="flex items-start">
            <div className="w-full md:pr-12 lg:pr-16">
              ...
              <h1 className="font-migra mt-8 text-white text-5xl md:text-7xl lg:text-6xl tracking-[0.04em]">
                With a sake list and cocktail menu like ours, the only way to do
                it properly is bottle service.
              </h1>
              <p className="mt-8 space-y-6 font-space leading-relaxed text-[#F0E9DF]">
      ...
      <Section>
        <div className="">
          ...
          <h1 className="font-migra mt-[1.5em] capitalize text-center text-5xl md:text-7xl lg:text-5xl tracking-[0.04em] text-center text-[#FF3B11]">
            / Your own table, Reserved for the night /
          </h1>
          <h1 className="font-migra capitalize text-center text-5xl md:text-7xl lg:text-5xl tracking-[0.04em] text-center text-[#FF3B11]">
      ...
      <Section className="py-16">
        <div className="flex flex-col lg:flex-row items-stretch gap-8">
          ...
          <div className="w-full lg:w-1/2 flex">
            <div className="border rounded-xl border-[#FF3B11] p-10 lg:p-14 w-full flex flex-col justify-center">
              <p className="font-space font-extrabold text-center text-xs uppercase tracking-[0.2em] text-[#FF3B11]">
                Cocktail of the Month
              </p>

              <h3 className="font-migra font-extrabold text-center text-5xl mt-7 text-[#FF3B11]">
                The Accidental Expert
              </h3>

              <p className="font-space text-center leading-relaxed mt-7 text-[#FF3B11]">
          ...
          {/* Image */}
          <div className="w-full lg:w-1/2 flex">
            <div className="relative w-full min-h-[400px] lg:h-auto">
              <Image
                src="/expert.png"
        ...
        <div>
          <div className="border border-[#FF3B11] p-10 lg:p-10 text-center flex flex-col items-center bg-transparent">
            <div className="w-full lg:w-[65%] mx-auto text-center">
              <h2 className="mt-5 font-migra font-extrabold text-[#F0E9DF] capitalize text-4xl md:text-5xl lg:text-6xl leading-none">
                Planning a big celebration?
              </h2>

              <div className="mt-7 font-space leading-relaxed text-[#F0E9DF]">
                <h1 className="font-migra text-white text-4xl md:text-5xl lg:text-6xl tracking-[0.04em]">
      ...
      <Section className="bg-claret/30">
        <div className="w-full lg:w-[55%] mx-auto">
          ...
          <p className="font-space mt-8 mx-auto text-base leading-relaxed">
            Wednesday to Friday — late night dining and DJs from 5pm. Expect
            RNB, AFRO, and Funky House.
          </p>
          <p className="font-space mx-auto text-base leading-relaxed">
